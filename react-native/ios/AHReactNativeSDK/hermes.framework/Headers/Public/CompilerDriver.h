...
__attribute((visibility("default"))) CompileResult compileFromCommandLineOptions(const std::string &jsPath, const std::string &outPath);
...
//extern llvh::cl::opt<std::string> BytecodeOutputFilename;
